  ...
  return (
    ...
    <div className='container max-w-[654px] min-h-[650px] bg-[#FFFFFF] shadow-xl shadow-[#A1D2D5] '>
           ...
           <div className='mb-4 px-2'>
              ...
              <button className='bg-[#D9D9D9B5] text-[#010101] text-[14px] font-medium  w-full py-3 rounded-md'>Sign In</button>
              <button className='bg-[#D9D9D9B5] text-[#010101] text-[14px] font-medium  w-full py-3 rounded-md'>Not Register?</button>
